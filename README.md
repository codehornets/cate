...
<p align="center">
  <strong>Current source version:</strong> v1.0.4
</p>
...
If you just want to use Cate, download a prebuilt release — don't build from source. This repository currently targets **v1.0.4**.
